...
locals {
  ...
  # values.service.appProtocol follows Kubernetes' own appProtocol convention
  ...
  # schema stays k8s-native. Anything not listed here (including unset) maps
  # to Cloud Run's "http1".
  port_name_by_app_protocol = {
    "http"              = "http1"
